# Instalación y carga de paquetes necesarios para todo el análisis
...
matriz_datos <- matrix(c(73, 68, 74, 71, 
                         73, 67, 75, 72, 
                         75, 68, 78, 73, 
                         73, 71, 75, 75, 
                         67, 70, 68, 69), 
...
rownames(matriz_datos) <- paste("Rollo", 1:5)
colnames(matriz_datos) <- paste("Agente", 1:4)
